<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="artistList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="参与艺人名称" align="center" prop="artistName" />
...
<script>
import { listArtist, getArtist, delArtist, addArtist, updateArtist } from "@/api/album/artist";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除参与艺人编号为"' + ids + '"的数据项？').then(function() {
